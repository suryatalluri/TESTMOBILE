...
import com.testmobile.database29thsep.service.SampleService;
import java.io.*;
...
import com.testmobile.database29thsep.service.*;
 ...
 */
@RestController(value = "Database29thSep.SampleController")
@RequestMapping("/Database29thSep/Sample")
...
public class SampleController {
    ...
    @Autowired
    @Qualifier("Database29thSep.SampleService")
    ...
    public Sample editSample(@PathVariable("id") Integer id, @RequestBody Sample instance) throws EntityNotFoundException {
